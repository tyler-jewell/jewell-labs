...
- Attach company skill **`sendblue`** (source: `skills/sendblue/SKILL.md`) + **`paperclip`** via `tools/paperclip_sendblue_setup.sh <agentId>`.
- Operator guide: `docs/SENDBLUE_PAPERCLIP.md`. Persona notes: `agents/messaging.md`.
