...
llama.cpp/ollama + grok + Claude. Read `README.md` for the architecture and `CLAUDE.md`-style
memory for context. Two rules below are load-bearing — do not violate them.
